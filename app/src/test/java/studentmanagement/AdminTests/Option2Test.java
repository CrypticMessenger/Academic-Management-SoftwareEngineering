...
public class Option2Test {
    ...
    public void setUp() {
        ...
        DatabaseUtils.executeUpdateQuery(conn, "insert into config_number values(2)");

    }

    @ParameterizedTest
    @CsvSource({ "2,1", "2,2", "2,3", "2,4", "2,5" })
    public void testOption2(String choice, Integer expected) {
        String result;
        String input = "";
